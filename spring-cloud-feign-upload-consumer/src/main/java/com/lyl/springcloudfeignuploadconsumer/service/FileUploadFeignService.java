...
import com.lyl.springcloudfeignuploadconsumer.config.FeignMultipartSupportConfig;
 ...
 * Version 1.0
 **/
@FeignClient(value = "file-server", configuration = FeignMultipartSupportConfig.class)
